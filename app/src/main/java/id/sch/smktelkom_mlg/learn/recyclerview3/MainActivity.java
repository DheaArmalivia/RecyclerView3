    ...
    private void doFilter(String mQuery) {
        ...
        if (query == null || query.isEmpty()) {
            ...
            for (int i = 0; i < mListAll.size(); i++) {
                ...
                if (hotel.judul.toLowerCase().contains((CharSequence) query) ||
                        hotel.deskripsi.toLowerCase().contains((CharSequence) query) ||
                        hotel.lokasi.toLowerCase().contains((CharSequence) query)) {
                    mList.add(hotel);
